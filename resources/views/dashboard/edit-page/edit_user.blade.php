                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a href="{{ route('show.user') }}" class="btn btn-warning btn-sm">Back</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            placeholder="Enter User Name" value="{{ old('name') }} {{$data->name}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number"
                                            ...
                                            placeholder="Enter Number" value="{{ old('number') }} {{$data->number}}">
                                        <span class="text-danger">
                                            @error('number')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password"
                                            ...
                                            placeholder="Enter Password" value="{{ old('password') }} {{$data->password}}">
                                        <span class="text-danger">
                                            @error('password')
                                                {{ $message }}
                                            @enderror
