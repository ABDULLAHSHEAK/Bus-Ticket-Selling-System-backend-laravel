                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bus_name" id="BusName"
                                            ...
                                            <option value="{{ $date_time->bus->id }}">{{ $date_time->bus->bus_name }}
                                            </option>
                                            @foreach ($bus as $data)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="trip_date"
                                            ...
                                            placeholder="Enter Trip Model" value="{{ $date_time->trip_date }}">
                                        <span class="text-danger">
                                            @error('trip_date')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="timepicker">
                                            <input type="time" name="trip_time"
                                                ...
                                                data-target="#timepicker" value="{{ $date_time->trip_time }}" />
                                            <span class="text-danger">
                                                @error('trip_time')
                                                    {{ $message }}
                                                @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="start_from" id="BusName"
                                            ...
                                            <option value="{{ $date_time->StartLocation->id }}">
                                                {{ $date_time->StartLocation->place_name }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="destination"
                                            ...
                                            <option value="{{ $date_time->EndLocation->id }}">
                                                {{ $date_time->EndLocation->place_name }}</option>
