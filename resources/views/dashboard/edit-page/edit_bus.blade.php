                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bus_name"
                                            ...
                                            placeholder="Enter Bus Name" value="{{ $data->bus_name }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bus_model"
                                            ...
                                            placeholder="Enter Bus Model" value="{{ $data->bus_model }}">
                                        <span class="text-danger">
                                            @error('bus_model')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="supervisor_name"
                                            ...
                                            placeholder="Enter SupervisorName KM" value="{{ $data->supervisor_name }}">
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="supervisor_number"
                                            ...
                                            placeholder="Enter Supervisor Number" value="{{ $data->supervisor_number }}">
                                        <span class="text-danger">
