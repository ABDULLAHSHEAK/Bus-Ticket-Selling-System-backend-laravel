                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h3 class="card-title">Edit Fare</h3>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="base_location" id="BaseLocation"
                                            ...
                                            <option value="{{$fares->MainLocation->id}}">{{$fares->MainLocation->place_name}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="start_from" id="StartLocation"
                                            ...
                                            <option value="{{$fares->StartLocation->id}}">{{$fares->StartLocation->place_name}}</option>
                                            @foreach ($place as $data)
                                                <option value="{{ $data->id }}">{{ $data->place_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="destination" id="EndLocation"
                                            ...
                                            <option value="{{$fares->EndLocation->id}}">{{$fares->EndLocation->place_name}}</option>
                                            @foreach ($place as $data)
                                                <option value="{{ $data->id }}">{{ $data->place_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fare_amount"
                                            ...
                                            placeholder="Enter Fare Amount" value="{{ $fares->fare_amount }}" />
                                        <span class="text-danger">
                                            @error('fare_amount')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="timepicker">
                                            <input type="Date" name="effect_from"
                                                ...
                                                data-target="#timepicker" placeholder="Enter Date" value="{{ $fares->effect_from }}" />
                                            <span class="text-danger">
                                                @error('effect_from')
                                                    {{ $message }}
                                                @enderror
